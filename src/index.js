...
nextBtn.addEventListener('click', () => {
  ...
  document.getElementsByClassName('choiceAndResultContainer')[0].style.display =
    'none';
  document.getElementsByClassName('mainResultContainer')[0].style.display =
    'flex';
});
...
function updateScore() {
  ...
  if (playerScore.win > playerScore.lose) {
    ...
    document.getElementById('mainResultText').textContent =
      'YOU LOST AGAINT PC';
    document.getElementById('resultMsg').textContent = 'OOPS!!';
  }
}
